            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <div v-else-if="entries.length === 0" class="py-12 text-center text-gray-500 dark:text-gray-400">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">Nenhuma entrada ativa encontrada</h3>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            Todas as entradas foram concluídas ou canceladas, ou ajuste seus filtros.
                        </p>
                    </div>
