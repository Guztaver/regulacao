...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Exames Prontos', href: '/entries/exam-ready' },
];
...
async function loadScheduledEntries() {
    ...
    try {
        ...
        const response = await entryApi.getExamReadyEntries(filters);
        entries.value = Array.isArray(response) ? response : response.data || [];
    } catch (err) {
        console.error('Erro ao carregar exames prontos:', err);
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Exames Prontos</h1>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Entradas com exames prontos para conclusão ({{ entries.length }} entradas)</p>
                </div>
                ...
                <div class="flex gap-2">
                    <Dialog v-model:open="isFilterDialogOpen">
                        ...
                        <DialogContent class="sm:max-w-md">
                            <DialogHeader>
                                <DialogTitle>Filtrar Exames Prontos</DialogTitle>
                            </DialogHeader>
            ...
            <Card>
                <CardHeader>
                    <CardTitle>Exames Prontos</CardTitle>
                </CardHeader>
                <CardContent>
                    ...
                    <div v-else-if="entries.length === 0" class="py-12 text-center text-muted-foreground">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-foreground">Nenhum exame pronto encontrado</h3>
                        <p class="mt-1 text-sm text-muted-foreground">Não há exames prontos no momento ou ajuste seus filtros.</p>
                    </div>
